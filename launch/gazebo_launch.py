...
#     world_file_name = 'office_env_large_second.world' 
...
#     world = os.path.join('/home/yaozhuo/code/ros2_ws/src/gz_spawner', 'world', world_file_name)

#     gazebo = ExecuteProcess(cmd=['gz','sim', '--verbose', '-s', 'libgazebo_ros_init.so', '-s', 'libgazebo_ros_factory.so', world], output='screen')
...
def generate_launch_description():
    ...
    #world_file_name = 'empty_with_ros.sdf' 
    #world = os.path.join('/home/yaozhuo/code/ros2_ws/src/gz_spawner', 'world', world_file_name)

    sdf_path = '/home/yaozhuo/code/ros2_ws/src/lamapf_and_gazebo/world/empty_with_ros.sdf'
